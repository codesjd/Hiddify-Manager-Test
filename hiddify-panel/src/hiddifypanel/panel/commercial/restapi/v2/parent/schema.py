...
class SyncInputSchema(Schema):
    ...
    hconfigs = fields.List(
        fields.Nested(HConfigSchema), required=False, metadata={"description": "The list of configs"}
    )
...
class SyncOutputSchema(Schema):
    users = fields.List(fields.Nested(UserSchema), required=True, metadata={"description": "The list of users"})
    admin_users = fields.List(
        fields.Nested(AdminSchema), required=True, metadata={"description": "The list of admin users"}
    )
