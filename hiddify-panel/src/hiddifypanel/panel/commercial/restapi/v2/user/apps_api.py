...
class AppInstall(Schema):
    title = String()
    type = Enum(
        AppInstallType, required=True, metadata={"description": "The platform that provides the app to download"}
    )
...
class AppAPI(MethodView):
    ...
    def __get_ua_platform(self):
        ...
        if os == "Android":
            ...
            return Platform.ios
        elif "Linux" in request.user_agent.string and (
            "X11" in request.user_agent.string or "Wayland" in request.user_agent.string
        ):
    ...
    def __get_all_apps_dto(self):
        ...
        return [
            ...
            v2rayng_app_dto,
            foxray_app_dto,
            shadowrocket_app_dto,
            streisand_app_dto,
            loon_app_dto,
            stash_app_dto,
            singbox_app_dto,
            cmfa_app_dto,
            clash_verge_rev_app_dto,
    ...
    def __get_v2rayn_app_dto(self):
        ...
        ins_url = (
            f"https://github.com/2dust/v2rayN/releases/latest/download/v2rayN-windows-64-SelfContained-With-Core.7z"
        )
    ...
    def __get_v2rayng_app_dto(self):
        ...
        github_ins_url = (
            latest_url.split("releases/")[0] + f"releases/download/{version}/v2rayNG_{version}_universal.apk"
        )
        ...
        dto.install = [
            ...
            self.__get_app_install_dto(AppInstallType.google_play, google_play_ins_url),
        ]
        return dto
        ...
        for install_type in installation_types:
            ...
            match install_type:
                case AppInstallType.apk:
                    ...
                    ins_url = (
                        latest_url.split("releases/")[0] + f"releases/download/{version}/SFA-{version}-universal.apk"
                    )
                ...
                case AppInstallType.dmg:
                    latest_url, version = get_latest_release_url(f"https://github.com/SagerNet/sing-box")
                    ins_url = (
                        latest_url.split("releases/")[0] + f"releases/download/{version}/SFM-{version}-universal.dmg"
                    )
    ...
    def __get_cmfa_app_dto(self):
        ...
        ins_url = (
            latest_url.split("releases/")[0] + f"releases/download/{version}/cmfa-{version}-meta-universal-release.apk"
        )
    ...
    def __get_hiddify_next_app_dto(self):
        ...
        for install_type in installation_types:
            ...
            match install_type:
                ...
                case AppInstallType.appimage:
                    ins_url = (
                        f"{self.hiddify_github_repo}/hiddify-next/releases/latest/download/Hiddify-Linux-x64.AppImage"
                    )
                case AppInstallType.dmg:
